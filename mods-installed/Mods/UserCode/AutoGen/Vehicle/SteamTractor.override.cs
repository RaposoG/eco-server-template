...
namespace Eco.Mods.TechTree
{
    ...
    [RequireComponent(typeof(VehicleTreeHarvestComponent))]
    ...
    public partial class SteamTractorObject : PhysicsWorldObject, IRepresentsItem
    {
        ...
        private static readonly Type[] AttachmentTypeList = new Type[]
        {
            ...
            typeof(SteamTractorTreeCutterItem),
        };
        protected override void Initialize()
        {
            ...
            this.GetComponent<VehicleTreeHarvestComponent>().Initialize(
            disallowedSpecies:new string [] {
                "OldGrowthRedwood",
                            "Palm",
                            "SaguaroCactus",
                        });
            ...
            this.GetComponent<VehicleToolComponent>().Initialize(12, 1950000,
