...
namespace Eco.Mods.TechTree
{
    ...
    public partial class IronShovelRecipe : RecipeFamily
    {
        public IronShovelRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(IronShovelRecipe), start: 0.5f, skillType: typeof(BlacksmithSkill));
    ...
    public partial class IronShovelItem : ShovelItem
    {
        ...
        private static IDynamicValue damage                 = CreateDamageValue(1, typeof(SelfImprovementSkill), typeof(IronShovelItem));
        private static IDynamicValue tier                   = new ConstantValue(2);
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(IronShovelItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
