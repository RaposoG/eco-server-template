...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Hydrocolloids" item. 
    ...
    [LocDisplayName("Hydrocolloids")] // Defines the localized name of the item.
    [SalvageCost(typeof(FoodScrap), 0.4f)]
    [Weight(100)] // Defines how heavy the Hydrocolloids is.
    [LocDescription("Used to make collids for bursts of flavor.")] //The tooltip description for the food item.
