...
namespace Eco.Mods.TechTree
{
    ...
    public partial class IronHammerItem : HammerItem
    {
        ...
        private static IDynamicValue damage                 = CreateDamageValue(1, typeof(SelfImprovementSkill), typeof(IronHammerItem));
        private static IDynamicValue tier                   = new ConstantValue(4);
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(IronHammerItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
