...
{
    [Serialized, Weight(200), MaxStackSize(1), LocDisplayName("Fridge Trailer")]
    [LocDescription("Fridge Transport Trailer")]
    public partial class FridgeTrailerItem : Item
    {
        
    }

    [RequiresSkill(typeof(IndustrySkill), 4)]
    public partial class FridgeTrailerRecipe : RecipeFamily
    {
        public FridgeTrailerRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "Fridge Trailer",  //noloc
                displayName: Localizer.DoStr("Fridge Trailer"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(FridgeTrailerRecipe), start: 10, skillType: typeof(IndustrySkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Truck"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Fridge Trailer"), recipeType: typeof(FridgeTrailerRecipe));
        ...
        //{
        //    ModelType = typeof(FridgeTrailerRecipe).Name,
        //    Assembly = typeof(FridgeTrailerRecipe).AssemblyQualifiedName,
        ...
        //    ProductList =
        //    [
        //        new EMCraftable("FridgeTrailerItem"),
        //    ],
        ...
        //};
        //
        //static FridgeTrailerRecipe() { EMRecipeResolver.AddDefaults(Defaults); }
        //
        //public FridgeTrailerRecipe()
        //{
