...
namespace Eco.Mods.TechTree
{
    ...
    [RequireRoomVolume(8)]
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Bedroom", subPageName: "Bed2 Item")]
    public partial class Bed2Object : WorldObject, IRepresentsItem
    {
        public Type RepresentedItemType => typeof(Bed2Item);
        public override LocString DisplayName => Localizer.DoStr("Bed2");
        public override TableTextureMode TableTexture => (TableTextureMode)1;

        static Bed2Object()
        {
            WorldObject.AddOccupancy<Bed2Object>(new List<BlockOccupancy>
            {
        ...
        {
            this.GetComponent<HousingComponent>().HomeValue = Bed2Item.homeValue;
        }
    }
    ...
    [Tag("CanBeOnRug")]
    [Weight(2000)]
    public partial class Bed2Item : WorldObjectItem<Bed2Object>
    {
        public static readonly HomeFurnishingValue homeValue = new HomeFurnishingValue
        {
            ObjectName = Localizer.DoStr("Bed2"),
    ...
    [Ecopedia("Housing Objects", "Bedroom", subPageName: "Bed2 Item")]
    public partial class Bed2Recipe : RecipeFamily
    {
        public Bed2Recipe()
        {
            ...
            recipe.Init(
                name: "Bed2",
                displayName: Localizer.DoStr("Bed2"),
                ...
                {
                    new CraftingElement<Bed2Item>(1f),
                });

            this.Recipes = new List<Recipe> { recipe };
            this.ExperienceOnCraft = 2f;
            this.LaborInCalories = CreateLaborInCaloriesValue(60f, typeof(LoggingSkill));
            this.CraftMinutes = CreateCraftTimeValue(typeof(Bed2Recipe), 2f, typeof(LoggingSkill));

            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Bed2"), typeof(Bed2Recipe));
