...
namespace Eco.EM.Machines.Trucking
{
    ...
    [LocDescription("Logging Trailer")]
    public partial class LoggingTrailerItem : Item
    {
    ...
    public partial class LoggingTrailerRecipe : RecipeFamily
    {
        public LoggingTrailerRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "Logging Trailer",  //noloc
                displayName: Localizer.DoStr("Logging Trailer"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(LoggingTrailerRecipe), start: 10, skillType: typeof(IndustrySkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Truck"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Logging Trailer"), recipeType: typeof(LoggingTrailerRecipe));
