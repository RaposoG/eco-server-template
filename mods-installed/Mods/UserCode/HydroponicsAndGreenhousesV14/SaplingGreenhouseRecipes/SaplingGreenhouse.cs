...
//////////////////////////////////////5x5x13Back//////////////////////////////////////
        ...
        {
            var isAuthorized = ServiceHolder<IAuthManager>.Obj.IsAuthorized(this, context.User, AccessType.FullAccess, null, out _);
	...
	[MaxStackSize(200)]
    [AllowPluginModules(ItemTypes = new[] { typeof(LoggingBasicUpgradeItem), typeof(BasicUpgradeItem), typeof(AdvancedUpgradeItem), typeof(ModernUpgradeItem) })] //noloc
    ...
    public partial class SaplingGreenhouseRecipe : RecipeFamily
    {
        public SaplingGreenhouseRecipe()
        {
            ...
            recipe.Init(
                ...
                {
					new IngredientElement(typeof(GlassItem), 80, typeof(CarpentrySkill)),
                    new IngredientElement(typeof(NailItem), 60, typeof(CarpentrySkill)),
                    new IngredientElement("Lumber", 40, typeof(CarpentrySkill)), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SaplingGreenhouseRecipe), start: 10, skillType: typeof(CarpentrySkill));
