...
namespace Eco.Mods.TechTree
{
    ...
    [LocDescription("Animal Husbandry allows you to breed Cows and Sheep while also producing milk and butter.")]
    ...
    public partial class AnimalHusbandrySkillBookRecipe : RecipeFamily
    {
        public AnimalHusbandrySkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                {
                    new IngredientElement(typeof(CulinaryResearchPaperBasicItem), 5, typeof(HuntingSkill)),
                    new IngredientElement(typeof(AgricultureResearchPaperAdvancedItem), 5, typeof(HuntingSkill)),
                    new IngredientElement("Basic Research", 5, typeof(HuntingSkill)),
                },
