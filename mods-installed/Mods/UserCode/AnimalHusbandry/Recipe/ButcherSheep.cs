...
namespace Eco.Mods.TechTree
{
        ...
        RecipeFamily
    {
        public ButcherSheepRecipe()
        {
            ...
            recipe.Init(
                name: "ButcherSheep",  //noloc
                displayName: Localizer.DoStr("Butcher Sheep"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
               new IngredientElement(typeof(SheepItem), 1, typeof(ButcherySkill)),  
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(ButcherSheepRecipe), 1.5f, typeof(ButcherySkill));     
