...
{
    [Serialized]
    [LocDisplayName("Prime Mover - Long Nose")]
    [Weight(25000)]
    [AirPollution(0.9f)]
    [Ecopedia("Crafted Objects", "Vehicles", createAsSubPage: true)]
    [LocDescription("Modern Prime Mover, Can be driven as is or combined with a trailer?")]
    public partial class OptimusPrimeMoverItem : WorldObjectItem<OptimusPrimeMoverObject>, IPersistentData
    {
        [Serialized, SyncToView, NewTooltipChildren(CacheAs.Instance, flags: TTFlags.AllowNonControllerTypeForChildren)] public object PersistentData { get; set; }
    }

    [RequiresSkill(typeof(IndustrySkill), 4)]
    public partial class OptimusPrimeMoverRecipe : RecipeFamily
    {
        public OptimusPrimeMoverRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "Prime Mover - Long Nose",  //noloc
                displayName: Localizer.DoStr("Prime Mover - Long Nose"),
                ...
                {
                    new CraftingElement<OptimusPrimeMoverItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(OptimusPrimeMoverRecipe), start: 10, skillType: typeof(IndustrySkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Truck"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Prime Mover - Long Nose"), recipeType: typeof(OptimusPrimeMoverRecipe));
    ...
    public partial class OptimusPrimeMoverObject : PhysicsWorldObject, IRepresentsItem
    {
        public override LocString DisplayName => Localizer.DoStr("PrimeMover");
        public Type RepresentedItemType => typeof(OptimusPrimeMoverItem);

        public override float InteractDistance => 16f;
        public override TableTextureMode TableTexture => TableTextureMode.Metal;

        static OptimusPrimeMoverObject()
        {
            AddOccupancy<OptimusPrimeMoverObject>(new List<BlockOccupancy>(0));
        }
        ...
        private OptimusPrimeMoverObject() { }
