    ...
    static Dictionary<UserStatType, IDynamicValue> dynamicValuesDictionary = new Dictionary<UserStatType, IDynamicValue>()
    {
        ...
        },
        {
            UserStatType.MaxCarryWeight, new MultiDynamicValue(MultiDynamicOps.Sum,
                ...
                new ConstantValue(80000)) // 80 kg, in grams. Stock value is ToolbarBackpackInventory.DefaultWeightLimit.
        },
        {
        ...
        {
            UserStatType.BackpackSlots, new ConstantValue(ToolbarBackpackInventory.DefaultBackpackSlots)
        },
        {
            UserStatType.CarriedSlots, new ConstantValue(UserInventory.DefaultCarriedSlots)
        }
    };
