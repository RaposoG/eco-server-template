...
namespace Eco.EM.Machines.Trucking
{
    ...
    public partial class SemiTrailerItem : Item
    {
    ...
    public partial class SemiTrailerRecipe : RecipeFamily//, IConfigurableRecipe
    {
        ...
        public SemiTrailerRecipe()
        {
            ...
            recipe.Init(
                name: "Logistics Trailer",  //noloc
                displayName: Localizer.DoStr("Logistics Trailer"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SemiTrailerRecipe), start: 10, skillType: typeof(IndustrySkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Truck"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Logistics Trailer"), recipeType: typeof(SemiTrailerRecipe));
