...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SteelShovelRecipe : RecipeFamily
    {
        public SteelShovelRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SteelShovelRecipe), start: 0.5f, skillType: typeof(BlacksmithSkill));
    ...
    public partial class SteelShovelItem : ShovelItem
    {
        ...
        private static IDynamicValue damage                 = CreateDamageValue(1, typeof(SelfImprovementSkill), typeof(SteelShovelItem));
        private static IDynamicValue tier                   = new ConstantValue(3);
        private static SkillModifiedValue skilledRepairCost = new SkillModifiedValue(2, BlacksmithSkill.MultiplicativeStrategy, typeof(BlacksmithSkill), typeof(SteelShovelItem), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
        ...
        public override int MaxTake                     => 15;
