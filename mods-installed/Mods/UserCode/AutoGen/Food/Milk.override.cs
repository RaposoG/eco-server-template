...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "Milk" item. 
    ...
    [LocDisplayName("Milk")] // Defines the localized name of the item.
    [SalvageCost(typeof(FoodScrap), 0.4f)]
    [Tag("Fat")]
    [Weight(300)] // Defines how heavy the Milk is.
    [LocDescription("Milk, although maybe not from an animal.")] //The tooltip description for the food item.
    public partial class MilkItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 3, Fat = 10, Protein = 7, Vitamins = 5};
