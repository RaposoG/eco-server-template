...
namespace Eco.EM.Machines.Trucking
{
    ...
    public partial class MiningTrailerItem : Item
    {
    ...
    public partial class MiningTrailerRecipe : RecipeFamily//, IConfigurableRecipe
    {
        public MiningTrailerRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "Mining Trailer",  //noloc
                displayName: Localizer.DoStr("Mining Trailer"),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MiningTrailerRecipe), start: 10, skillType: typeof(IndustrySkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Truck"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Car Carrier Trailer"), recipeType: typeof(MiningTrailerRecipe));
