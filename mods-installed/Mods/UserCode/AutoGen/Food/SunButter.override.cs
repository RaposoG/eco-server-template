...
namespace Eco.Mods.TechTree
{
    ...
    /// <summary>
    /// <para>
    /// Server side food item definition for the "SunButter" item. 
    ...
    [Tag("Oil")]
    [Weight(300)]
    [LocDescription("Moo juice in a solidified form.")] //The tooltip description for the food item.
    public partial class SunButterItem : FoodItem
    {
        ...
        public override Nutrients Nutrition             => new Nutrients() { Carbs = 1, Fat = 10, Protein = 2, Vitamins = 0};
