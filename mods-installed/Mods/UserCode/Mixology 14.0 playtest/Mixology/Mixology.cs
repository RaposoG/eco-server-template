...
namespace Eco.Mods.TechTree
{
    ...
    public class MixologyMod : IModInit
    {
        public static ModRegistration Register() => new() 
        { 
            ModName = "Mixology",
            ModDescription = "A mod that adds drinks to the food menu and allows you to become a master mixologist",
            ModDisplayName = "Mixology",
        };
    }
    ...
    [LocDescription("An introduction to making basic drinks and smoothies. Levels up by crafting related unleavened recipes.")]
    ...
    public partial class MixologySkill : Skill
    {
        ...
        public override int SpecialtyCost => 3;
    }
    ...
    [Ecopedia("Professions", "Chef", subPageName: "Mixology Skill Book Item")]
        ...
        public MixologySkillBookRecipe()
        {
            ...
            recipe.Init(
                ...
                ingredients: new List<IngredientElement>
                {
                    ...
                    new IngredientElement(typeof(MetallurgyResearchPaperBasicItem), 5, true),
                    new IngredientElement("Basic Research", 10, true), //noloc
                },
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MixologySkillBookRecipe), start: 15, skillType: typeof(CampfireCookingSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Mixology Skill Book"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Mixology Skill Book"), recipeType: typeof(MixologySkillBookRecipe));
